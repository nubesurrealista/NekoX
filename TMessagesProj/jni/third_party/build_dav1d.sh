...
cp -fv "$PREFIX/arm64-v8a/lib/libdav1d.a" ../../ffmpeg/arm64-v8a/
...
cp -fv "$PREFIX/armeabi-v7a/lib/libdav1d.a" ../../ffmpeg/armeabi-v7a/
...
cp -fv "$PREFIX/x86/lib/libdav1d.a" ../../ffmpeg/x86/
...
cp -fv "$PREFIX/x86_64/lib/libdav1d.a" ../../ffmpeg/x86_64/
