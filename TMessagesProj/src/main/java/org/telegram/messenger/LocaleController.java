        ...
        try {
            ...
            if (dateDay == day && year == dateYear) {
                ...
                if (usePersianCalendar) {
                    ...
                    return LocaleController.formatString("formatDateAtTime", R.string.formatDateAtTime, getInstance().getChatDate().format(new Date(date)), getInstance().formatterDay.format(new Date(date)));
                }
            } else {
                if (usePersianCalendar) {
                    ...
                    return LocaleController.formatString("formatDateAtTime", R.string.formatDateAtTime, getInstance().getChatFullDate().format(new Date(date)), getInstance().formatterDay.format(new Date(date)));
                }
            }
        } catch (Exception e) {
            FileLog.e(e);
        ...
        try {
            ...
            if (dateDay == day && year == dateYear) {
                ...
                if (usePersianCalendar) {
                    ...
                    String format = LocaleController.formatString("formatDateAtTime", R.string.formatDateAtTime, getInstance().getFormatterDayMonth().format(new Date(date)), getInstance().formatterDay.format(new Date(date)));
                    return LocaleController.formatString("LastSeenDateFormatted", R.string.LastSeenDateFormatted, format);
                }
            } else {
                if (usePersianCalendar) {
                    ...
                    String format = LocaleController.formatString("formatDateAtTime", R.string.formatDateAtTime, getInstance().getFormatterYear().format(new Date(date)), getInstance().formatterDay.format(new Date(date)));
                    return LocaleController.formatString("LastSeenDateFormatted", R.string.LastSeenDateFormatted, format);
                }
            }
        } catch (Exception e) {
