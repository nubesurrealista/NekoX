        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            switch (holder.getItemViewType()) {
                ...
                case 2:
                    ...
                    if (currentType == TYPE_BLOCKED) {
                        actionCell.setText(LocaleController.getString(R.string.BlockUser), null, R.drawable.baseline_person_add_24, false);
                    } else {
                        actionCell.setText(LocaleController.getString(R.string.PrivacyAddAnException), null, R.drawable.baseline_person_add_24, uidArray.size() > 0);
                    }
                    break;
                case 3:
