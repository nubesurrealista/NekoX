...
public class CallLogActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, MainTabsActivity.TabFragmentDelegate {
	...
	private static class CallCell extends FrameLayout {
		...
		private static ImageSpan iconOut(Context context) {
			...
			greenDrawable.setColorFilter(new PorterDuffColorFilter(Theme.getColor(Theme.key_windowBackgroundWhiteGrayText3), PorterDuff.Mode.SRC_IN));
		...
		private static ImageSpan iconIn(Context context) {
			...
			greenDrawable2.setColorFilter(new PorterDuffColorFilter(Theme.getColor(Theme.key_windowBackgroundWhiteGrayText3), PorterDuff.Mode.SRC_IN));
		...
		private static ImageSpan iconMissedOut(Context context) {
			...
			redDrawable2.setColorFilter(new PorterDuffColorFilter(Theme.getColor(Theme.key_fill_RedNormal), PorterDuff.Mode.SRC_IN));
	...
	private void createActionMode() {
		...
		if (hasMainTabs) {
			...
			actionModeCloseView.setColorFilter(new PorterDuffColorFilter(getThemedColor(Theme.key_actionBarActionModeDefaultIcon), PorterDuff.Mode.SRC_IN));
