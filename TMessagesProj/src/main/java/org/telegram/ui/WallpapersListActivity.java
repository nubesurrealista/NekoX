...
public class WallpapersListActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() {
            ...
            public void onItemClick(int id) {
                if (id == -1) {
                    ...
                    builder.setMessage(LocaleController.formatString(R.string.DeleteChatBackgroundsAlert));
        ...
        if (currentType == TYPE_ALL) {
            ...
            actionModeViews.add(actionMode.addItemWithWidth(forward, R.drawable.baseline_forward_24, AndroidUtilities.dp(54), LocaleController.getString(R.string.Forward)));
            actionModeViews.add(actionMode.addItemWithWidth(delete, R.drawable.baseline_delete_24, AndroidUtilities.dp(54), LocaleController.getString(R.string.Delete)));
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            switch (holder.getItemViewType()) {
                case 0: {
                    ...
                    if (position == uploadImageRow) {
                        textCell.setTextAndIcon(LocaleController.getString(R.string.SelectFromGallery), R.drawable.baseline_image_24, true);
                    } else if (position == setColorRow) {
                        textCell.setTextAndIcon(LocaleController.getString(R.string.SetColor), R.drawable.baseline_palette_24, true);
                    } else if (position == resetRow) {
