...
public class ActionBarLayout extends FrameLayout implements INavigationLayout, FloatingDebugProvider {
    ...
    public class LayoutContainer extends FrameLayout {
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            int bottomTabsHeight = 0; // (isKeyboardVisible || shouldHideTabs()) ? 0 : getBottomTabsHeight(false);
...
//        }
    ...
    @Override
    public boolean dispatchTouchEvent(MotionEvent ev) {
        final boolean tabs = !shouldHideTabs(); // !shouldHideTabs() && ev.getY() > getHeight() - getBottomTabsHeight(true); // false?
    ...
    public int getBottomTabsHeight(boolean animated) {
        if (main && bottomSheetTabs != null && !shouldHideTabs())
