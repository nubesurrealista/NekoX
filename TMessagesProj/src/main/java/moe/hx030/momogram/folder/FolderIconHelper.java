package moe.hx030.momogram.folder;
...
public class FolderIconHelper {
    ...
    static {
        folderIcons.put(null, R.drawable.filter_all);
    ...
    public static int getPadding() {
        if (MomoConfig.tabsTitleType.Int() == NekoXConfig.TITLE_TYPE_MIX) {
    ...
    public static int getTotalIconWidth() {
        int result = 0;
        if (MomoConfig.tabsTitleType.Int() != NekoXConfig.TITLE_TYPE_TEXT) {
    ...
    public static int getTabIcon(String emoji) {
        ...
        return MomoConfig.ignoreFilterEmoticonUpdate.Bool() ? -1 : R.drawable.filter_custom;
    }
